...
@Slf4j
@Component
public class AxleCounterArbAdmHandler implements AuxiliaryDecisionHandler {
    ...
    public void handle(AuxiliaryDecision auxiliaryDecision) throws RuntimeException {
        ...
        //更新流程图
        axleCounterUpdateFlowchartsService.updateArbExecute(auxiliaryDecision.getTableInfoId(), auxiliaryDecision.getExecuteStep());
    }
