...
/**
 * @author kangyi
 * @description arb计轴故障复位
 * @date 2022年 01月15日 14:51:46
 */
@Slf4j
@Component
public class AxleCounterArbResetAdmHandler implements AuxiliaryDecisionHandler {
    ...
    public void handle(AuxiliaryDecision auxiliaryDecision) throws RuntimeException {
        ...
        //更新流程图
        axleCounterResetUpdateFlowchartsService.updateArbReset(auxiliaryDecision.getTableInfoId(), auxiliaryDecision.getExecuteStep());
    }
