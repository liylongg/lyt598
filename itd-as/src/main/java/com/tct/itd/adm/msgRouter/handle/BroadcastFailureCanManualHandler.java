...
@Slf4j
@Component
public class BroadcastFailureCanManualHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        ...
        log.info("广播故障-人工广播可用" + alarmInfo);
        ...
        admIdea.setAlarmTypeDetailStr(admAlertDetailTypeService.getDescByCode(alarmInfo.getAlarmTypeDetail()));//设置故障子类型文本信息,前端显示
