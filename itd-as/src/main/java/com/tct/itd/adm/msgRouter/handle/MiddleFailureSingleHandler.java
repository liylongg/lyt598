...
/**
 * @classname: MiddleFailureSingleHandler
...
@Component
@Slf4j
public class MiddleFailureSingleHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        ...
        log.info("道岔故障-线路中间站道岔故障(非小交路折返-影响单行),录入参数:{}", alarmInfo);
        // 设置推荐指令步骤
