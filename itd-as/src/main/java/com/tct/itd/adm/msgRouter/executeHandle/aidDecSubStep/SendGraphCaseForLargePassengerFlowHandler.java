 ...
 */
@Service("sendGraphCaseForLargePassengerFlow")
@Slf4j
public class SendGraphCaseForLargePassengerFlowHandler implements AidDecSubStepHandler {
    ...
    public void handle(AlarmInfo alarmInfo, AidDesSubStepOutDto dto) {
        log.info("推送运行图调整方案列表,推送车站ID：{}", alarmInfo.getStationId());
