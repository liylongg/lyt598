...
/**
 * @classname: BehindFailureChangeHandler
 * @description: 终端站后折返道岔故障可换轨
 * @author: liyunlong
 * @date: 2023/3/21 9:53
 */
@Slf4j
@Service
public class BehindFailureChangeHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        ...
        log.info("道岔故障-终端站后折返道岔故障可换轨录入参数:{}", alarmInfo);
        // 设置推荐指令步骤
