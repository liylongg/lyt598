...
/**
 * @author kangyi
 * @description 计轴故障-道岔区段计轴故障
 * @date 2022年 01月15日 14:03:24
 */
@Slf4j
@Component
public class AxleCounterAlarmSwitchHandler implements AlarmInfoMessageHandler {
    ...
    private void axleCounterRecovery(AlarmInfo alarmInfo) {
        ...
        //获取推送到前端的
        AdmIdea admIdea = axleCounterService.getAdmIdea(alarmInfo, AlarmTypeConstant.AXLE_COUNTER_SWITCH, executeStep, executeStepType, descByCode);
        //设置故障详情
        ...
        appPushService.sendMessage(MsgTypeEnum.REPORTED_MSG, admInfo);
        //更新流程图
        axleCounterUpdateFlowchartsService.switchPushRecovery(alarmInfo);
    }
