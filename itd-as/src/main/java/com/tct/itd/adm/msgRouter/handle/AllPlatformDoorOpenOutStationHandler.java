...
/**
 * @Description 站台门故障-列车出站过程中站台门打开
 * @Author yl
 * @Date 2021/9/1 10:20
 **/
@Slf4j
@Component
public class AllPlatformDoorOpenOutStationHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        log.info("站台门故障-列车出站过程中站台门打开,产生故障:{}", alarmInfo);
        // 设置站台,停车区域编号信息
