...
/**
 * @classname: MiddleFailureUpDownStrategyThree
 * @description: 线路中间站道岔故障(非小交路折返 - 影响上下行)第三次推荐指令策略类
 * @author: liyunlong
 * @date: 2023/3/2 16:41
 */
@Slf4j
@Service
public class MiddleFailureUpDownStrategyThree extends SwitchFailureStrategy {
    ...
    public String strategy() {
        return SwitchFailureStrategyConstant.MIDDLE_FAILURE_UP_DOWN_THREE;
    }
}
