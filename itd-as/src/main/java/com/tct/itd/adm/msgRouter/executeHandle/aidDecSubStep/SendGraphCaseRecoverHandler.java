...
/**
 * @Description 故障恢复晚点获取运行图预览方案
 * @Author yuelei
 * @Date 2021/9/27 15:27
 */
@Service("sendGraphCaseRecover")
@Slf4j
public class SendGraphCaseRecoverHandler implements AidDecSubStepHandler {
    ...
    public void handle(AlarmInfo alarmInfo, AidDesSubStepOutDto dto) {
        AdmRunGraphCases admRunGraphCases = new AdmRunGraphCases();
        //设置执行步骤为-2，表示需要定时调图
        admRunGraphCases.setExecuteStep(IidsConstPool.EXECUTE_STEP_0_2);
...
//            result.setCompressTrainGraphString("");
//            result.setBeforeTrainGraphString("");
