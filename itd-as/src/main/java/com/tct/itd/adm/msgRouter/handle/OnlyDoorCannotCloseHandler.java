...
/**
 * @Description 车门故障-单车门无法关闭
 * @Author yl
 * @Date 2022/6/15 14:15
 **/
@Slf4j
@Component
public class OnlyDoorCannotCloseHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        ...
        //点击解除故障按钮，推送故障恢复推荐指令
            ...
            //更新流程图
            alarmFlowchartService.setExecuteFlags(alarmInfo.getTableInfoId(), Lists.newArrayList(10,30));
        }
    }
