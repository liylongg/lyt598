...
@Slf4j
@Component
public class AxleCounterAlarmArbHandler implements AlarmInfoMessageHandler {
    ...
    private void pushAuxiliaryDecisionFirst(AlarmInfo alarmInfo) {
        ...
        String descByCode = AdmAlertDetailTypeService.getDescribeByCode(String.valueOf(alarmInfo.getAlarmTypeDetail()));
        ...
        log.info("产生故障:{},alarmInfo:{}", AdmAlertDetailTypeService.getDescribeByCode(String.valueOf(alarmInfo.getAlarmTypeDetail())), JsonUtils.toJSONString(alarmInfo));
        //设置推荐指令步骤
        ...
        //更新流程图步骤
        axleCounterUpdateFlowchartsService.pushFirstAux(alarmInfo);
    }
    ...
    private void axleCounterRecovery(AlarmInfo alarmInfo) {
        ...
        //更新流程图
        axleCounterUpdateFlowchartsService.arbPushRecovery(alarmInfo);
        String descByCode = AdmAlertDetailTypeService.getDescribeByCode(String.valueOf(alarmInfo.getAlarmTypeDetail()));
        ...
        //获取推送到前端的
        AdmIdea admIdea = axleCounterService.getAdmIdea(alarmInfo, String.valueOf(alarmInfo.getAlarmTypeDetail()), executeStep, executeStepType, descByCode);
        //推送弹窗显示时长
    ...
    public String channel() {
        return AlarmTypeConstant.AXLE_COUNTER_ARB;
    }
}
