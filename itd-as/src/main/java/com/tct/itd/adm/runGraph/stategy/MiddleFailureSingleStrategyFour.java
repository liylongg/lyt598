...
/**
 * @classname: MiddleFailureSingleStrategyFour
 * @description: 线路中间站道岔故障(非小交路折返站 - 影响单行)第四次推荐指令策略类
 * @author: liyunlong
 * @date: 2023/3/1 20:22
 */
@Slf4j
@Service
public class MiddleFailureSingleStrategyFour extends SwitchFailureStrategy{
    ...
    public String strategy() {
        return SwitchFailureStrategyConstant.MIDDLE_FAILURE_SINGLE_FOUR;
    }
}
