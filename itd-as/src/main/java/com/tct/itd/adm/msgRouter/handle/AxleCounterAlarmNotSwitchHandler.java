...
@Slf4j
@Component
public class AxleCounterAlarmNotSwitchHandler implements AlarmInfoMessageHandler {
    ...
    private void pushAuxiliaryDecisionFirst(AlarmInfo alarmInfo) {
        ...
        //更新流程图步骤
        axleCounterPreUpdateFlowchartsService.pushFirstAux(alarmInfo);
    }
    ...
    private void axleCounterRecovery(AlarmInfo alarmInfo) {
        ...
        //获取推送到前端的
        AdmIdea admIdea = axleCounterService.getAdmIdea(alarmInfo, AlarmTypeConstant.AXLE_COUNTER_NOT_SWITCH, executeStep, executeStepType, descByCode);
        //设置故障详情
        ...
        appPushService.sendMessage(MsgTypeEnum.REPORTED_MSG, admInfo);
        //更新流程图
        axleCounterPreUpdateFlowchartsService.notSwitchPushRecovery(alarmInfo);
    }
