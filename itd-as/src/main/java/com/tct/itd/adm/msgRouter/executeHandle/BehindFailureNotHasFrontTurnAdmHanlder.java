...
/**
 * @classname: BehindFailureNotHasFrontTurnAdmHanlder
 * @description: 线路终点站常态化站后折返道岔故障,不具备站前折返Handler(bj)
 * @author: liyunlong
 * @date: 2021/12/23 14:33
 */
@Slf4j
@Service
public class BehindFailureNotHasFrontTurnAdmHanlder implements AuxiliaryDecisionHandler {
