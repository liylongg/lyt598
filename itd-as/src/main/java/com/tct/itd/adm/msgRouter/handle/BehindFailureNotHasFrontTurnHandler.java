...
/**
 * @classname: BehindFailureNotHasFrontTurnHandler
 * @description: 终端站折返道岔故障，不具备站前折返Handler
 * @author: liyunlong
 * @date: 2021/12/23 14:24
 */
@Slf4j
@Service
public class BehindFailureNotHasFrontTurnHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        ...
        log.info("道岔故障-线路终点站常态化站后折返道岔故障,不具备站前折返录入参数:{}", alarmInfo);
        // 设置推荐指令步骤
