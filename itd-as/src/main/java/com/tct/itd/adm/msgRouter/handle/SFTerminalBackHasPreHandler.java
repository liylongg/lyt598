...
/**
 * @classname: SFTerminalBackHasPreHandler
 * @description: 终端站折返道岔故障, 具备本站折返Handler
 * @author: liyunlong
 * @date: 2021/12/20 19:10
 */
@Slf4j
@Service
public class SFTerminalBackHasPreHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        ...
        log.info("道岔故障-终端站折返道岔故障,具备本站折返录入参数:{}", alarmInfo);
        // 设置推荐指令步骤
