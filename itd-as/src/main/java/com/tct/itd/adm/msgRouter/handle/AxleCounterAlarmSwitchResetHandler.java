...
@Slf4j
@Component
public class AxleCounterAlarmSwitchResetHandler implements AlarmInfoMessageHandler {
    ...
    private void axleCounterRecovery(AlarmInfo alarmInfo) {
        ...
        //获取推送到前端的
        AdmIdea admIdea = axleCounterService.getAdmIdea(alarmInfo, AlarmTypeConstant.AXLE_COUNTER_SWITCH_RESET, executeStep, executeStepType, descByCode);
        //设置故障详情
