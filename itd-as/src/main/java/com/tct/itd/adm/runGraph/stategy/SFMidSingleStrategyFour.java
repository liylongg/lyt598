 ...
 * @description: 道岔故障-中间道岔故障-影响单行第四次推荐指令预览图策略类
 * @author: liyunlong
 * @date: 2021/12/28 18:11
 */
@Slf4j
@Service
public class SFMidSingleStrategyFour extends SwitchFailureStrategy{
    ...
    public String strategy() {
        return SwitchFailureStrategyConstant.SWITCH_FAILURE_MIDDLE_SINGLE_FOUR;
    }
}
