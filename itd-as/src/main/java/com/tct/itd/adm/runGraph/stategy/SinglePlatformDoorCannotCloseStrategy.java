...
/**
 * @author kangyi
 * @description 站台门故障-单档站台门无法关闭
 * @date 2021/10/28
 **/
@Service
@Slf4j
public class SinglePlatformDoorCannotCloseStrategy extends AbstractPrePlanRunGraphStrategy implements IPrePlanRunGraphStrategy {
