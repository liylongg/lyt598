...
/**
 * @classname: MiddleFailureUpDownHandler
 * @description: 线路中间站道岔故障(非小交路折返 - 影响上下行)
 * @author: liyunlong
 * @date: 2023/3/2 16:29
 */
@Component
@Slf4j
public class MiddleFailureUpDownHandler implements AlarmInfoMessageHandler {
    ...
    public void handle(AlarmInfo alarmInfo) {
        ...
        log.info("道岔故障-线路中间站道岔故障(非小交路折返站-影响上下行),录入参数:{}", alarmInfo);
        // 设置推荐指令步骤
