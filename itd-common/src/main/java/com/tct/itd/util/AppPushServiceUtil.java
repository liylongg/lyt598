...
import com.tct.itd.enums.ServiceIdEnum;
import com.tct.itd.enums.ServiceTypeEnum;
...
@Slf4j
@Component
public class AppPushServiceUtil {
    ...
    public static <T> void sendMessageByRestFull(Message message, String stationIds){
        ...
        try {
            ...
            AppPushClient appPushClient = SpringContextUtil.getBean(AppPushClient.class);
